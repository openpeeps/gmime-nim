...
when defined(macosx):
  ...
  {.passC:"-I /usr/include -I /usr/include/gmime-3.0 -I/usr/include/glib-2.0/ -I/usr/lib/x86_64-linux-gnu/glib-2.0/include".}
  ...
  {.error: "Unsupported platform. Please add the appropriate include and library paths for your system." .}
